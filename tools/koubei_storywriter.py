...
def build_prompt(payload, style):
    ...
    "10) 「その他のコメント」では、上記で既に扱った項目（ポジティブ・ネガティブ）の内容やテーマを絶対に繰り返さないでください。\n"
    "    特に『外観』『燃費』『内装』『乗り心地』『静粛性』『価格』『安全性』など、上記に出た語句や話題は再登場させないでください。\n"
    "    新しく言及されていない補足的・限定的な意見（例：特定の機能・装備・使い勝手・細部デザインなど）のみを選んでください。\n"
    "    もしそのような新しい意見がまったく存在しない場合は、『### その他のコメント』セクション自体を出力しないでください。\n"
    "    ただし、可能であれば必ず何らかの補足的評価を1〜2件記載することを優先してください。\n"
