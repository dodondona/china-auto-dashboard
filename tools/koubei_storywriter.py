...
def build_prompt(payload, style):
    ...
    user = (
        ...
        "   各項目は2〜3文構成とし、具体例や背景説明を適度に加えてください。\n"
        "3) ネガティブな要点も同様に「**項目名：** 内容説明＋代表的な口コミ」の形式でまとめてください。\n"
        "   各項目は1文で終わらせず、課題の理由や背景を1〜2文補足してください。\n"
        "4) 各項目には代表的な口コミを1〜3文程度で引用・要約して補足してください。\n"
        "   （例：“○○が便利”“△△が不満”との声もある、“□□が改善点”といった指摘がある）\n"
        ...
        "導入文（1〜2段落、全体傾向の要約）\n\n"
        "### ポジティブな評価点\n"
        "- **項目名：** 内容説明（2〜3文程度）。口コミ例を交えて具体的に説明。\n"
        "  （例：“○○が快適”“△△が魅力的”との声もある）\n\n"
        "### ネガティブな評価点\n"
        "- **項目名：** 課題内容（2〜3文程度）。背景や原因を添え、具体的コメントを引用。\n"
        "  （例：“□□が不便”“△△に不満”との指摘が見られる）\n\n"
        "### 総括\n"
